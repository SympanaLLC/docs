...
1. **[Install Sympana Connector](https://www.sympana.com/connector)** inside your GoHighLevel agency and authorize the sub-accounts that need Vapi-powered automations.
2. **[Learn how to use Sympana Connector](https://www.sympana.com/university)** through Sympana's setup form to sync tools, phone numbers, and calendars instantly.
3. **[Get fifty pre built GoHighLevel automations](https://www.sympana.com/pre-built-automations)** or clone them to customize outbound campaigns, inbound routing trees, appointment schedulers, and post-call follow-ups.
